...
;                     dbf        d0,.relocLoop
                     ...
                     jsr        generator_precalc
                     jsr        LSPBankMapper
                     mulu       #12,d0                                   ; move past instruments as they are now patched
                     lea        (a0,d0.w),a0
...
.noVd:               add.b      d0,d0
                     ...
                     ;move.b     (a0)+,$c9-$a0(a6)
                     move.b     (a0)+,d3
                     move.b     d3,Variables+SampleVolume+1
                     move.b     d3,$c9-$a0(a6)
.noVc:               add.b      d0,d0
                     bcc.s      .noVb
                     move.b     (a0)+,$b9-$a0(a6)
...
.noReset:            ;move.l     (a2)+,(a5)
                     ...
                     move.l     a2,d4
                     subq.l     #4,d4
                     sub.l      m_lspInstruments-4(a1),d4
                     divu       #12,d4
                     move.w     d4,Variables+SampleTrigger               ; waveform trigger
                     move.l     d3,Variables+SamplePointer
.notrig  
                     move.l     d3,(a5)
