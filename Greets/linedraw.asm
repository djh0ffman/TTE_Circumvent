...
.positiveDY
    ...
    lea          .octant_lookup,a2
    move.b       (a2,d6.w),d6
    or.w         #BLTCON1F_LINE|BLTCON1F_SING,d6
...
.positiveGradient
    ...
    or.w         #BLTCON0F_USEA|BLTCON0F_USEC|BLTCON0F_USED|LINE_MINTERMX,d2
    move.w       d2,bltcon0(a6)
    move.w       d6,bltcon1(a6)
